...
interface RawMaterialsDataTableProps {
  columns: ColumnDef<RawMaterialRow>[];
  data: RawMaterialRow[];
  searchQuery: string;
  onSearchChange: (value: string) => void;
  onEdit?: (item: RawMaterialRow) => void;
  onDelete?: (item: RawMaterialRow) => void;
  isDeletingId?: number | null;
  onGetReports?: () => void;
}

export function RawMaterialsDataTable({
  columns,
  data,
  searchQuery,
  onSearchChange,
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 py-8">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-foreground">
                        {searchQuery ? 'No results found' : 'No raw materials found'}
                      </p>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-3">
            <div className="text-sm text-muted-foreground">
              ...
              <span className="font-medium text-foreground">{totalRows}</span> row
              {totalRows !== 1 ? 's' : ''}
            </div>
