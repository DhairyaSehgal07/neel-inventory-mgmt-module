                  ...
                  <div className="flex flex-col items-center justify-center gap-3 py-8">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-foreground">
                        {searchQuery ? "No results found" : "No fabric widths found"}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        {searchQuery
                          ? `No fabric widths match "${searchQuery}". Try a different search term.`
                          : "Get started by adding a new fabric width."}
                      </p>
                    </div>
                  </div>
                </TableCell>
      ...
      {totalRows > 0 && (
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{totalRows}</span> fabric width
            {totalRows !== 1 ? "s" : ""}
          </div>
