...
interface CompoundsDataTableProps {
  columns: ColumnDef<CompoundRow>[];
  data: CompoundRow[];
  searchQuery: string;
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 py-8">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-foreground">
                        {searchQuery ? 'No results found' : 'No compounds found'}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        {searchQuery
                          ? `No compounds match "${searchQuery}". Try a different search term.`
                          : 'Get started by adding a new compound.'}
                      </p>
                    </div>
                  </div>
                </TableCell>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-3">
            <div className="text-sm text-muted-foreground">
              {searchQuery && (
                <span className="mr-2">
                  Found <span className="font-medium text-foreground">{totalRows}</span>{' '}
              ...
              <span className="font-medium text-foreground">{totalRows}</span> compound
              {totalRows !== 1 ? 's' : ''}
            </div>
