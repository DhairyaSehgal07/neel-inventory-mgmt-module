...
function buildMatrixUrl(appendSharedQueryParams: (sp: URLSearchParams) => void) {
      ...
      <CardHeader className="border-b pb-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-1.5">
            <CardTitle className="text-lg">Width × strength stock matrix (incl: packed, open)</CardTitle>
            <CardDescription>
              Packed + open balance (meters) for every width and strength. Darker cells
              hold more stock; hatched cells are gaps (no meters).
            </CardDescription>
          </div>
          <button
            type="button"
          ...
          <div className="space-y-4">
            ...
            <div className="text-muted-foreground flex flex-col gap-3 text-xs sm:flex-row sm:items-center sm:justify-between">
              ...
              <p className="max-w-md text-[11px] leading-snug">
                ...
                over- or under-represented in packed + open stock. Hover a cell for exact
                meters and roll count.
              </p>
            </div>
          </div>
        )}
